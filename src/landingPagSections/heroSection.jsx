    ...
    <>
      <div className='bg-bgBlack min-h-screen'>
        ...
        <div className='flex flex-col items-center justify-center size-full'>
          <div className='text-[58px] bg-clip-text text-transparent bg-gradient-to-r from-white/20 to-white font-semibold max-w-[50rem] mt-[15rem] text-center leading-[1.2]'>
          ...
          <div className='mt-16 relative w-1/4 overflow-hidden rounded-full'>
            <input type='email' className='rounded-full overflow-hidden bg-transparent outline-none w-full text-white border-stroke/25 border-2 p-4' />
            <div className='absolute right-0 overflow-visible flex items-center justify-center p-3 h-full w-fit  top-0'>
              <button className=' bg-accent h-full px-6 rounded-full [box-shadow:0px_0px_15px_#92E4F8] relative'>Sign In</button>
            </div>
          </div>
        </div>

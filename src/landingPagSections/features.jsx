    ...
    <div className='min-h-screen'>
      <div className=' w-auto flex flex-col items-center justify-center'>
        <div className='flex flex-col items-center justify-center'>
          <p className='text-accent text-[2rem] font-medium'>
            Features
          </p>

          <p className='max-w-[40vw] bg-clip-text text-transparent bg-gradient-to-r mt-6 text-2xl from-white/20 to-white font-semibold text-center'>
            Transforming education with tools that save time, ensure quality, and enable seamless quiz sharing.
          </p>

        </div>
        <div className='flex md:flex-row flex-col mt-[10rem] justify-center max-w-7xl gap-16'>
          <Card icon="/public/paper.svg" title="Question Paper Generation" description="Quickly generate customized question papers tailored to specific subjects, topics, and difficulty levels." />

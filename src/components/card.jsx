...
export default function Card({ title, description, icon }) {
    return (
        <div className='bg-cardBg max-w-[24vw] flex flex-col  border-stroke/25 border-[0.1rem] p-8 rounded-[2rem] hover:-translate-y-4 transition-all duration-300 hover:shadow-accent/20 shadow-2xl'>
